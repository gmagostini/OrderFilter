...
class ConertFileGui(App):
    ...
    def build(self):
        ...
        self.load_file = Button(text = "load file", size = (200,20), size_hint = (None, None) )
        self.load_file.bind(on_press = self.extract_order)
        self.html = Button(text = "HTML", size = (200,20), size_hint = (None, None) )
        self.pdf = Button(text="pdf", size=(200, 20), size_hint=(None, None))
